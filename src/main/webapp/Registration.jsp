									...
									<form action="Registration" method="get">
										...
										<div class="form-outline mb-4">
											<input type="email" id="form3Example3cg"
												class="form-control form-control-lg" name="email" required/> <label
										...
										<div class="form-outline mb-4">
											<input type="number" id="form3Example4cdg"
												class="form-control form-control-lg" name="phone" required="required" /> <label
												class="form-label" for="form3Example4cdg" >Phone
												Number </label>
										</div>
										<div class="form-outline mb-4">
