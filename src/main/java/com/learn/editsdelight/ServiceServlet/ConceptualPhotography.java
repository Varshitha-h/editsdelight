...
/**
 * Servlet implementation class ConceptualPhotography
 */
@WebServlet("/ConceptualPhotography")
public class ConceptualPhotography extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ConceptualPhotography() {
        super();
